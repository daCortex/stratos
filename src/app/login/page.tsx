  ...
  return (
    <>
      ...
      <main className="container-x" style={{ maxWidth: 440, paddingTop: 60, paddingBottom: 80 }}>
        ...
        {sp.error && <p className="pill" style={{ borderColor: "#e0556a", color: "#e0556a", marginTop: 14 }}>Couldn&apos;t sign you in. Check your details or try again.</p>}
        ...
        <p className="faint" style={{ marginTop: 8, fontSize: "0.85rem" }}>Need help? <a href={DISCORD_URL} target="_blank" rel="noreferrer" style={{ color: "var(--primary)" }}>Join our Discord</a></p>
      </main>
    </>
  );
}
